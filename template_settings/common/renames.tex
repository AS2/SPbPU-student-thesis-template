...
%%
%%
\newcommand{\Author}{А.С.\,Сачук} % И.О. Фамилия автора 
\newcommand{\AuthorFull}{Сачук Александр Сергеевич} % Фамилия Имя Отчество автора
\newcommand{\AuthorFullDat}{Сачуку Александру Сергеевичу} % Фамилия Имя Отчество автора в дательном падеже (Кому? Студенту...)
\newcommand{\AuthorFullVin}{Сачука Александра Сергеевича} % в винительном падеже (Кого? что?  Програмиста ...)
\newcommand{\AuthorPhone}{+7-950-016-60-60} % номер телефорна автора для оперативной связи  
...
\newcommand{\SupervisorDegree}{кандидат ф.-м. наук} %
\newcommand{\SupervisorTitle}{звание} % 
%%
%%
%Руководитель, утверждающий задание
\newcommand{\Head}{М. Е. Фролов} % И. О. Фамилия руководителя подразделения (руководителя ОП)
...
\newcommand{\ConsultantExtraDegree}{кандидат ф.-м. наук} % 
\newcommand{\ConsultantExtraVin}{Е.И.\,Пчицкую} % И. О. Фамилия дополнительного консультанта в винительном падеже (Кого? что? Руководителя ...)
\newcommand{\ConsultantExtraDegreeVin}{кандидата ф.-м. наук} %  в винительном падеже (Кого? что? Руководителя ...)
%%% Второй консультант
...
%%
%%
\renewcommand{\thesisTitle}{Автоматизация проведения исследований с использованием мультиагентных систем}
\newcommand{\thesisDegree}{магистерская диссертация}% дипломный проект, дипломная работа, магистерская диссертация %c 2020
\newcommand{\thesisTitleEn}{Research automation using multi-agent systems} %2020
\newcommand{\thesisDeadline}{дд.мм.2025} %Последний день преддипломной практики согласно учебному плану.
\newcommand{\thesisStartDate}{01.02.2025}
...
%%
%%
\newcommand{\keywordsRu}{Мультиагентные системы, автоматизация задач лабораторий, применение внутренних инструментов, применение инструментов различных типов, оптимизация контекста, мультимодальный анализ} % ВВЕДИТЕ ключевые слова по-русски
%%
%%
\newcommand{\keywordsEn}{Multi-agent systems, laboratory task automation, application of internal tools, application of different types of tools, context optimization, multimodal analysis} % ВВЕДИТЕ ключевые слова по-английски
%%
%%
